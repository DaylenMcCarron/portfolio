...
const AboutMe = (props: Props) => {
  return (<>
    <div className='w-screen h-[80vh] bg-gradient-to-br from-sky-50 via-70% via-white to-blue-100'>
      <div className='flex  w-[100%] h-[100%] '>
        
        <div className=' basis-2/3'>
          <div className='mx-24 h-[60%] my-24'>
            <h1 className=' text-3xl p-6 pt-1 font-semibold text-sky-900'>About Me:</h1>
            <p className=' text-lg pt-3 text-sky-800'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Aut quibusdam doloremque dolor ipsam aperiam officiis quisquam dolorem autem, cupiditate distinctio atque. Totam, temporibus. Omnis beatae quidem earum? Dicta, nobis soluta.
        ...
        <div className=' basis-1/3 '>
          <div className='group relative mx-24  h-[40%] my-12 border-2'>
        ...
        <div className=' bg-gradient-to-b from-black via-70% via-slate-800 to-slate-900 w-10 h-[82%] absolute left-2'></div>
        <div className=' bg-gradient-to-b from-black via-70% via-slate-800 to-slate-900 w-5 h-[82%] absolute right-2'></div>
      </div>
      
    </div>
    <div className='bg-black w-full h-2'></div>
    <div className='bg-blue-200 w-full h-2'></div>
    <div className='bg-black w-full h-2'></div>
    </>
  )
}

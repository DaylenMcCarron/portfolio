  ...
  return (
    ...
    <div className=' h-[100vh] w-screen text-cyan-50 '>
      <div className=' w-[100vw] h-[100vh] absolute' id="demo">
        <div id='js_icon' className={`md:w-16 md:h-16 h-10 w-10 absolute left-[25%]  top-[20%] rounded-md shadow-2xl hover:shadow-yellow-400 shadow-yellow-700 hover:scale-110 transition`}>
        ...
        <div id='react_icon' className={`md:w-16 md:h-16 h-10 w-10 rounded-md shadow-cyan-700 hover:shadow-cyan-600 shadow-2xl border-[0px] p-2 absolute right-[5%]  top-[20%] hover:scale-110 transition`}>
        ...
        <div id='html_icon' className={`md:w-16 md:h-16 h-10 w-10 bg-red-500 pt-2 p-3 absolute left-[5%]  top-[25%] rounded-md shadow-red-700 hover:shadow-red-500 shadow-2xl  hover:scale-110 transition`}>
        ...
        <div id='java_icon' className={`md:w-16 md:h-16 h-10 w-10 pt-1 p-3 absolute right-[10%]  top-[28%] rounded-md shadow-orange-700 hover:shadow-orange-500 shadow-2xl  hover:scale-110 transition`}>
        ...
        <div id='node_icon' className={`md:w-16 md:h-16 h-10 w-10 pt-3 p-1 absolute left-[10%]  top-[15%] rounded-md shadow-green-700 hover:shadow-green-500 shadow-2xl  hover:scale-110 transition`}>
        ...
        <div id='postgres_icon' className={`md:w-16 md:h-16 h-10 w-10 p-1 absolute left-[5%]  top-[35%] rounded-md shadow-blue-700 hover:shadow-blue-500 shadow-2xl  hover:scale-110 transition`}>
        ...
        <div id='mongodb_icon' className={`md:w-16 md:h-16 h-10 w-10 p-0 absolute right-[25%]  top-[15%] rounded-md shadow-green-700 hover:shadow-green-500 shadow-2xl  hover:scale-110 transition`}>
          <img  src="https://www.pngall.com/wp-content/uploads/13/Mongodb-PNG-Image-HD.png" alt="" />
        </div>
        <div id='firebase_icon' className={`md:w-16 md:h-16 h-10 w-10 p-0 absolute right-[35%]  top-[20%] rounded-md shadow-yellow-700 hover:shadow-yellow-500 shadow-2xl  hover:scale-110 transition`}>
          <img  src="https://cdn4.iconfinder.com/data/icons/google-i-o-2016/512/google_firebase-2-512.png" alt="" />
        </div>
        <div id='unity_icon' className={`md:w-16 md:h-16 h-10 w-10 p-1 absolute right-[5%]  top-[35%] rounded-md shadow-slate-700 hover:shadow-slate-500 shadow-2xl  hover:scale-110 transition`}>
          <img  src="https://cdn4.iconfinder.com/data/icons/various-icons-2/476/Unity.png" alt="" />
        </div>
        <div id='c++_icon' className={`md:w-16 md:h-16 h-10 w-10 p-1 absolute left-[40%]  top-[15%] rounded-md shadow-slate-700 hover:shadow-slate-500 shadow-2xl  hover:scale-110 transition`}>
          <img  src="https://cdn-icons-png.flaticon.com/512/6132/6132222.png" alt="" />
        </div>
        <div id='python_icon' className={`md:w-16 md:h-16 h-10 w-10 p-1 absolute left-[20%]  top-[30%] rounded-md shadow-slate-700 hover:shadow-slate-500 shadow-2xl  hover:scale-110 transition`}>
          <img  src="https://cdn3.iconfinder.com/data/icons/logos-and-brands-adobe/512/267_Python-512.png" alt="" />
        </div>
        <div id='linux_icon' className={`md:w-16 md:h-16 h-10 w-10 p-1 absolute left-[40%]  top-[25%] rounded-md shadow-slate-700 hover:shadow-slate-500 shadow-2xl  hover:scale-110 transition`}>
          <img  src="https://cdn-icons-png.flaticon.com/512/226/226772.png" alt="" />
        </div>
        <div id='css_icon' className={`md:w-16 md:h-16 h-10 w-10 p-3 pt-2 bg-blue-400 absolute right-[30%]  top-[30%] rounded-md shadow-blue-700 hover:shadow-blue-500 shadow-2xl  hover:scale-110 transition`}>
      ...
      <div className='absolute top-[50%] w-full h-2'>
        <p className='text-white text-center border-white border-2 w-[70%] mx-auto p-10'>Site Under Construction</p>
      </div>

    </div>
    <div>
      <h1 className=' w-full -z-10 absolute bottom-0 text-7xl lg:text-8xl font-bold text-center text-sky-50
      ' id='AboutMe'>Daylen McCarron</h1>
      <div className="w-[70%] h-0 relative left-[30%] -z-20">
        {/* Gradients */}

...
const Display = (props: Props) => {
  ...
  useEffect(() => {
    ...
    // layer 1
    document.getElementById('js_icon')?.setAttribute("style",`left:${100+posx}px;top:${600+posy}px`)
    ...
    document.getElementById('postgres_icon')?.setAttribute("style",`left:${350+posx*0.5}px;top:${150+posy*0.5}px`)
  ...
  return (
    <>
    <div className=' h-[90vh] w-screen text-cyan-50 bg-gradient-to-br from-black via-70% via-slate-800 to-slate-900'>
      <div className=' w-[100vw] h-[100vh] absolute' id="demo">
        ...
        <div id='react_icon' className={` w-16 h-16 rounded-md shadow-cyan-700 hover:shadow-cyan-600 shadow-2xl border-[0px] p-2 absolute top-[100px] hover:scale-110 transition`}>
        ...
        <div id='html_icon' className={` w-16 h-16 bg-red-500 pt-2 p-3 absolute top-[100px] rounded-md shadow-red-700 hover:shadow-red-500 shadow-2xl  hover:scale-110 transition`}>
        ...
        <div id='java_icon' className={`w-16 h-16 pt-1 p-3 absolute top-[100px] rounded-md shadow-orange-700 hover:shadow-orange-500 shadow-2xl  hover:scale-110 transition`}>
        ...
        <div id='node_icon' className={`w-16 h-16 pt-3 p-1 absolute top-[100px] rounded-md shadow-green-700 hover:shadow-green-500 shadow-2xl  hover:scale-110 transition`}>
        ...
        <div id='postgres_icon' className={`w-16 h-16 p-1 absolute top-[100px] rounded-md shadow-blue-700 hover:shadow-blue-500 shadow-2xl  hover:scale-110 transition`}>
        ...
        <div id='mongodb_icon' className={`w-16 h-16 p-0 absolute top-[100px] rounded-md shadow-green-700 hover:shadow-green-500 shadow-2xl  hover:scale-110 transition`}>
          <img  src="https://www.pngall.com/wp-content/uploads/13/Mongodb-PNG-Image-HD.png" alt="" />
        </div>
        <div id='firebase_icon' className={`w-16 h-16 p-0 absolute top-[100px] rounded-md shadow-yellow-700 hover:shadow-yellow-500 shadow-2xl  hover:scale-110 transition`}>
          <img  src="https://cdn4.iconfinder.com/data/icons/google-i-o-2016/512/google_firebase-2-512.png" alt="" />
        </div>
        <div id='unity_icon' className={`w-16 h-16 p-1 absolute top-[100px] rounded-md shadow-slate-700 hover:shadow-slate-500 shadow-2xl  hover:scale-110 transition`}>
          <img  src="https://cdn4.iconfinder.com/data/icons/various-icons-2/476/Unity.png" alt="" />
        </div>
        <div id='c++_icon' className={`w-16 h-16 p-1 absolute top-[100px] rounded-md shadow-slate-700 hover:shadow-slate-500 shadow-2xl  hover:scale-110 transition`}>
          <img  src="https://cdn-icons-png.flaticon.com/512/6132/6132222.png" alt="" />
        </div>
        <div id='python_icon' className={`w-16 h-16 p-1 absolute top-[100px] rounded-md shadow-slate-700 hover:shadow-slate-500 shadow-2xl  hover:scale-110 transition`}>
          <img  src="https://cdn3.iconfinder.com/data/icons/logos-and-brands-adobe/512/267_Python-512.png" alt="" />
        </div>
        <div id='linux_icon' className={`w-16 h-16 p-1 absolute top-[100px] rounded-md shadow-slate-700 hover:shadow-slate-500 shadow-2xl  hover:scale-110 transition`}>
          <img  src="https://cdn-icons-png.flaticon.com/512/226/226772.png" alt="" />
        </div>
        <div id='css_icon' className={`w-16 h-16 p-3 pt-2 bg-blue-400 absolute top-[100px] rounded-md shadow-blue-700 hover:shadow-blue-500 shadow-2xl  hover:scale-110 transition`}>

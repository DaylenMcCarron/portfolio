    ...
    <div className='w-full h-[70vh]'>
      <div className=' w-full h-full'>
        <h1 className='text-center text-6xl text-sky-200 sixtyfour py-2 pt-12' id="Skills">Skills</h1>
         <div className=' border-[1px] border-slate-700 glassbg shadow-sm shadow-slate-500 rounded-xl h-3/4 mt-3 m-auto w-[95%] text-white flex'>
          ...
          <div className='basis-[5%] flex flex-col'>
            <div className="  h-[50%] border-[1px] border-slate-200 hover:border-slate-200 shadow-slate-400 glassbg transition-all duration-200 ">
              <h1 className=" relative top-[50%] -rotate-90 text-xl text-nowrap font-bold">Front-end</h1>
            </div>
            <div className="bg-glass h-[50%] border-[1px] border-slate-600 hover:border-slate-200 shadow-slate-400  transition-all duration-200">
              <h1 className=" relative top-[50%] -rotate-90 text-xl text-nowrap">Back-end</h1>
            </div>
          </div>
